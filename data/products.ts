...
export const products: Product[] = [
  {
    ...
    weight: "500g",
    description:
      "Cafés Gourmet 100% Arábica. Café torrado, torra média clara. Tradição de raiz, alma mineira.",
    fullDescription:
      "Nosso café tem origem nas montanhas de Minas Gerais, cultivado há quatro gerações pela família Luís e Valquíria com afeto, cuidado e dedicação. O cultivo em altitudes acima de 900 metros permite um amadurecimento lento dos grãos, resultando em um sabor único e suave. Não precisa de açúcar - porque esse já vem Adoçado no Pé. Tradição de raiz, alma mineira, essência do café.",
    image: "/cafe500.png",
    category: "gourmet",
    featured: true,
    attributes: [
  ...
  },
  {
    ...
    description:
      "Cafés Gourmet 100% Arábica. Café torrado, torra média clara. Tradição de raiz, alma mineira.",
    fullDescription:
      "Nosso café tem origem nas montanhas de Minas Gerais, cultivado há quatro gerações pela família com afeto e cuidado. Cultivado em altitudes acima de 900 metros, o café Adoçado no Pé oferece um sabor incomparável. Tradição de raiz, alma mineira, essência do café.",
    image: "/cafe1.png",
    category: "gourmet",
    attributes: [
      { icon: "flame", label: "Torra média clara" },
